...
# Professional CSS styling with embedded background image
st.markdown("""
<style>
    ...
    /* Background with robotic warehouse automation image */
    .main > div {
        background: linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), 
                    url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1400 800"><defs><linearGradient id="floor" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:%23e5e5e5;stop-opacity:1" /><stop offset="100%" style="stop-color:%23cccccc;stop-opacity:1" /></linearGradient><linearGradient id="wall" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:%23f8f8f8;stop-opacity:1" /><stop offset="100%" style="stop-color:%23e0e0e0;stop-opacity:1" /></linearGradient><filter id="shadow" x="-50%" y="-50%" width="200%" height="200%"><feDropShadow dx="3" dy="3" stdDeviation="4" flood-color="black" flood-opacity="0.4"/></filter></defs><rect fill="url(%23wall)" width="1400" height="400"/><rect fill="url(%23floor)" y="400" width="1400" height="400"/><text x="80" y="120" font-family="Arial, sans-serif" font-size="42" font-weight="bold" fill="%23333" filter="url(%23shadow)">ROBOTIC</text><text x="80" y="170" font-family="Arial, sans-serif" font-size="28" font-weight="bold" fill="%23ff6b35">WAREHOUSE</text><text x="80" y="210" font-family="Arial, sans-serif" font-size="28" font-weight="bold" fill="%23ff6b35">AUTOMATION</text><g transform="translate(400, 300)"><rect x="0" y="80" width="120" height="80" rx="8" fill="%23ff6b35" filter="url(%23shadow)"/><rect x="5" y="85" width="110" height="15" rx="3" fill="%23fff" opacity="0.8"/><rect x="5" y="105" width="110" height="15" rx="3" fill="%23fff" opacity="0.6"/><rect x="5" y="125" width="110" height="15" rx="3" fill="%23fff" opacity="0.4"/><circle cx="60" cy="40" r="35" fill="%23333" filter="url(%23shadow)"/><circle cx="60" cy="40" r="25" fill="%23ff6b35"/><circle cx="60" cy="40" r="15" fill="%23fff"/><rect x="25" y="160" width="70" height="20" rx="10" fill="%23333"/><rect x="30" y="165" width="60" height="10" rx="5" fill="%23666"/></g><g transform="translate(600, 320)"><rect x="0" y="60" width="100" height="70" rx="6" fill="%23ff6b35" filter="url(%23shadow)"/><rect x="5" y="65" width="90" height="12" rx="2" fill="%23fff" opacity="0.7"/><rect x="5" y="82" width="90" height="12" rx="2" fill="%23fff" opacity="0.5"/><rect x="5" y="99" width="90" height="12" rx="2" fill="%23fff" opacity="0.3"/><circle cx="50" cy="30" r="25" fill="%23333" filter="url(%23shadow)"/><circle cx="50" cy="30" r="18" fill="%23ff6b35"/><circle cx="50" cy="30" r="10" fill="%23fff"/><rect x="20" y="130" width="60" height="15" rx="7" fill="%23333"/></g><g transform="translate(800, 310)"><rect x="0" y="70" width="130" height="85" rx="10" fill="%23ff6b35" filter="url(%23shadow)"/><rect x="5" y="75" width="120" height="18" rx="3" fill="%23fff" opacity="0.8"/><rect x="5" y="98" width="120" height="18" rx="3" fill="%23fff" opacity="0.6"/><rect x="5" y="121" width="120" height="18" rx="3" fill="%23fff" opacity="0.4"/><circle cx="65" cy="35" r="30" fill="%23333" filter="url(%23shadow)"/><circle cx="65" cy="35" r="22" fill="%23ff6b35"/><circle cx="65" cy="35" r="12" fill="%23fff"/><rect x="30" y="155" width="70" height="18" rx="9" fill="%23333"/></g><g transform="translate(1000, 325)"><rect x="0" y="55" width="110" height="75" rx="8" fill="%23ff6b35" filter="url(%23shadow)"/><rect x="5" y="60" width="100" height="15" rx="3" fill="%23fff" opacity="0.7"/><rect x="5" y="80" width="100" height="15" rx="3" fill="%23fff" opacity="0.5"/><rect x="5" y="100" width="100" height="15" rx="3" fill="%23fff" opacity="0.3"/><circle cx="55" cy="25" r="20" fill="%23333" filter="url(%23shadow)"/><circle cx="55" cy="25" r="15" fill="%23ff6b35"/><circle cx="55" cy="25" r="8" fill="%23fff"/><rect x="25" y="130" width="60" height="15" rx="7" fill="%23333"/></g><g transform="translate(1180, 315)"><rect x="0" y="65" width="95" height="70" rx="6" fill="%23ff6b35" filter="url(%23shadow)"/><rect x="5" y="70" width="85" height="12" rx="2" fill="%23fff" opacity="0.6"/><rect x="5" y="87" width="85" height="12" rx="2" fill="%23fff" opacity="0.4"/><rect x="5" y="104" width="85" height="12" rx="2" fill="%23fff" opacity="0.2"/><circle cx="47" cy="30" r="22" fill="%23333" filter="url(%23shadow)"/><circle cx="47" cy="30" r="16" fill="%23ff6b35"/><circle cx="47" cy="30" r="9" fill="%23fff"/><rect x="20" y="135" width="55" height="12" rx="6" fill="%23333"/></g><g stroke="%23ff6b35" stroke-width="2" fill="none" opacity="0.4"><path d="M400 500 L600 500 L800 500 L1000 500 L1200 500" stroke-dasharray="8,4"/><path d="M460 350 L650 370 L865 355 L1055 370 L1227 360" stroke-dasharray="5,3"/></g><g fill="%23666" opacity="0.3"><rect x="450" y="520" width="40" height="15" rx="2"/><rect x="510" y="525" width="35" height="12" rx="2"/><rect x="570" y="530" width="45" height="10" rx="2"/><rect x="640" y="520" width="50" height="15" rx="2"/><rect x="720" y="525" width="40" height="12" rx="2"/><rect x="780" y="530" width="55" height="10" rx="2"/><rect x="860" y="520" width="45" height="15" rx="2"/><rect x="930" y="525" width="40" height="12" rx="2"/><rect x="990" y="530" width="35" height="10" rx="2"/><rect x="1050" y="520" width="50" height="15" rx="2"/><rect x="1120" y="525" width="45" height="12" rx="2"/><rect x="1180" y="530" width="40" height="10" rx="2"/></g></svg>') center/cover no-repeat;
